...
<head>
	...
	<link href="${contextPath}/static/Hplus/css/plugins/jqgrid/ui.jqgrid.css" rel="stylesheet">
...
<body>
    ...
    $("#table_list_1").jqGrid({
        ...
        rowNum: 14,
        rowList: [10, 20, 30],
        colNames: ["id", "userName", "name", "pwd", "gender", "icon"],
        colModel: [
        	{name: "id", index: "id", width: 60, sorttype: "int"},
        	{name: "userName",index: "userName",width: 90 },
        	{name: "name", index: "name", width: 100 }, 
        	{name: "pwd", index: "pwd", width: 80  }, 
        	{name: "gender", index: "gender", width: 80, align: "right", sorttype: "float"}, 
